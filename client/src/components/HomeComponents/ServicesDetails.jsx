          ...
          <div className="flex flex-wrap justify-center gap-8 mt-8 h-[23rem] mb-[8rem]">
            <div className="bg-white p-6 rounded-[20px] w-[520px] shadow-now transition-transform duration-300 transform hover:scale-105 hover:shadow-up">
              ...
              <p className="text-gray-600 text-justify font-txt mt-4 ml-[12px] max-w-md">
                Combining advanced veterinary technology with a personal touch, we offer a full spectrum of services, 
                from wellness check-ups to emergency treatments. Trust PetLandia Vets for all your pet care needs.
              </p>
            </div>
            ...
            <div className="mt-8">  
              ...
              <div className="flex flex-wrap justify-center gap-8 mt-8 h-[23rem] ">
                <div className=" flex flex-col items-center bg-white p-6 rounded-[20px] shadow-now transition-transform duration-300 transform hover:scale-105 hover:shadow-up w-1/6">
                  <div className="w-28 h-28 p-3  rounded-full flex justify-center items-center overflow-hidden">
                    <img src="src/assets/ecare.png" alt="Services" className="w-full h-full object-contain" />
                  </div>
                  <h1 className="font-paytone text-[24px] font-bold text-[#3E3D3D] text-shadow-md mt-4">Emergency Care</h1>
                ...
                <div className="flex flex-col items-center  bg-white p-6 rounded-[20px] shadow-now transition-transform duration-300 transform hover:scale-105 hover:shadow-up w-1/6 ">
                  <div className="w-28 h-28 p-3 rounded-full flex justify-center items-center overflow-hidden">
                    <img src="src/assets/lab.png" alt="Services" className="w-full h-full object-contain" />
                  </div>
                  <h1 className="font-paytone text-[24px] font-bold text-[#3E3D3D] text-shadow-md mt-4">Laboratory Services</h1>
                ...
                <div className="flex flex-col items-center  bg-white p-6 rounded-[20px] shadow-now transition-transform duration-300 transform hover:scale-105 hover:shadow-up w-1/6 ">
                  <div className="w-28 h-28 p-3  rounded-full flex justify-center items-center overflow-hidden">
                    <img src="src/assets/vacc.png" alt="Services" className="w-full h-full object-contain" />
                  </div>
                  <h1 className="font-paytone text-[24px] font-bold text-[#3E3D3D] text-shadow-md mt-4">Vaccination</h1>
                  <p className="text-gray-800 font-txt mt-10">
                ...
                <div className="flex flex-col items-center  bg-white p-6 rounded-[20px] shadow-now transition-transform duration-300 transform hover:scale-105 hover:shadow-up w-1/6 ">
                  <div className="w-28 h-28 p-3  rounded-full flex justify-center items-center overflow-hidden">
                    <img src="src/assets/antirab.png" alt="Services" className="w-full h-full object-contain" />
                  </div>
                  <h1 className="font-paytone text-[24px] font-bold text-[#3E3D3D] text-shadow-md mt-4">Anti-rabies Vaccination</h1>
                  <p className="text-gray-800 font-txt">
              ...
              <div className="flex flex-wrap justify-center gap-8 mt-8 h-[23rem] mb-20">
                <div className="flex flex-col items-center bg-white p-6 rounded-[20px] shadow-now transition-transform duration-300 transform hover:scale-105 hover:shadow-up w-1/6 ">
                  <div className="w-28 h-28 p-3  rounded-full flex justify-center items-center overflow-hidden">
                    <img src="src/assets/deworm.png" alt="Services" className="w-full h-full object-contain" />
                  </div>
                  <h1 className="font-paytone text-[24px] font-bold text-[#3E3D3D] text-shadow-md mt-4">Deworming</h1>
                  <p className="text-gray-800 font-txt mt-10">
                ...
                <div className="flex flex-col items-center  bg-white p-6 rounded-[20px] shadow-now transition-transform duration-300 transform hover:scale-105 hover:shadow-up w-1/6 ">
                  <div className="w-28 h-28 p-3  rounded-full flex justify-center items-center overflow-hidden">
                    <img src="src/assets/confine.png" alt="Services" className="w-full h-full object-contain" />
                  </div>
                  <h1 className="font-paytone text-[24px] font-bold text-[#3E3D3D] text-shadow-md mt-4">Confinement</h1>
                  <p className="text-gray-800 font-txt mt-10">
                ...
                <div className="flex flex-col items-center  bg-white p-6 rounded-[20px] shadow-now transition-transform duration-300 transform hover:scale-105 hover:shadow-up w-1/6">
                  <div className="w-28 h-28 p-3  rounded-full flex justify-center items-center overflow-hidden">
                    <img src="src/assets/xray.png" alt="Services" className="w-full h-full object-contain" />
                  </div>
                  <h1 className="font-paytone text-[24px] font-bold text-[#3E3D3D] text-shadow-md mt-4">Diagnostic <br></br> X-ray</h1>
                  <p className="text-gray-800 font-txt">
                ...
                <div className="flex flex-col items-center bg-white p-6 rounded-[20px] shadow-now transition-transform duration-300 transform hover:scale-105 hover:shadow-up w-1/6">
                  <div className="w-28 h-28 p-3  rounded-full flex justify-center items-center overflow-hidden">
                    <img src="src/assets/hcall.png" alt="Services" className="w-full h-full object-contain" />
                  </div>
                  <h1 className="font-paytone text-[24px] font-bold text-[#3E3D3D] text-shadow-md mt-4">Housecall Services</h1>
                  <p className="text-gray-800 font-txt">
